...
import { useRequireTranscriberAuth } from '@/lib/infra/auth/useTranscriberAuth'
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Input id="phone" placeholder={t('transcriber.phoneExample')} value={phone} onChange={(e) => setPhone(e.target.value)} />
