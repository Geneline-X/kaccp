...
export default function TranscriberLoginClient({ locale }: { locale: string }) {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.replace(`/${locale}/transcriber/v2`);
    } catch (e: any) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1 text-right">
                <Link href={`/${locale}/speaker/login/forgot`} className="text-xs text-blue-600 hover:underline">
          ...
          <div className="mt-6 text-center space-y-4">
            <p className="text-gray-600">
              ...
              <button
                onClick={() => router.push(`/${locale}/transcriber/v2/register`)}
            ...
            <div className="pt-2 border-t border-gray-100">
              <Link href={`/${locale}/speaker/login`} className="text-sm text-gray-500 hover:text-gray-700">
