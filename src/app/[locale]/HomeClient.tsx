            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 border border-blue-200 shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 flex-1">
                  <Link href={`/${locale}/speaker/register`}>{t('home.speaker.registerBtn')}</Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="flex-1">
                  <Link href={`/${locale}/speaker/login`}>{t('home.speaker.loginBtn')}</Link>
                </Button>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 border border-green-200 shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button asChild size="lg" className="bg-green-600 hover:bg-green-700 flex-1">
                  <Link href={`/${locale}/transcriber/v2/register`}>{t('home.transcriber.registerBtn')}</Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="flex-1">
                  <Link href={`/${locale}/transcriber/login`}>{t('home.transcriber.loginBtn')}</Link>
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <Link href={`/${locale}/speaker`} className="hover:text-white transition-colors">{t('footer.speakerPortal')}</Link>
              <Link href={`/${locale}/transcriber/v2`} className="hover:text-white transition-colors">{t('footer.transcriberPortal')}</Link>
              <Link href={`/${locale}/reviewer`} className="hover:text-white transition-colors">{t('footer.reviewerPortal')}</Link>
              <Link href={`/${locale}/leaderboard`} className="hover:text-white transition-colors">{t('footer.leaderboard')}</Link>
              <Link href={`/${locale}/admin/v2`} className="hover:text-white transition-colors">{t('footer.admin')}</Link>
            </div>
          </div>
